...
<form action="<?php echo esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ); ?>" class="post-password-form" method="post">
	...
	<div class="_c-input-group">
		...
		<input class="_c-input-group__btn" type="submit" name="Submit" value="<?php echo esc_attr( apply_filters( 'inc2734_wp_basis_password_form_submit_label', $submit_label ) ); ?>" />
	</div>
</form>
